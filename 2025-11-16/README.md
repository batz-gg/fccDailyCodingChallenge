...
* **Passed:**1. `countRectangles(1, 3)` should return `6`.
* **Passed:**2. `countRectangles(3, 2)` should return `18`.
* **Passed:**3. `countRectangles(1, 2)` should return `3`.
* **Passed:**4. `countRectangles(5, 4)` should return `150`.
* **Passed:**5. `countRectangles(11, 19)` should return `12540`.
